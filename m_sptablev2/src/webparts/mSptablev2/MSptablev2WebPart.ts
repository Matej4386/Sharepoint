...
import * as strings from 'MSptablev2WebPartStrings';
import MSptablev2 from './components/MSptablev2';
import { IMSptablev2Props } from './components/IMSptablev2Props';

export interface IMSptablev2WebPartProps {
  listId: string;
  filterConfiguration: IFilterConfiguration[];
  searchConfiguration: string;
}

export default class MSptablev2WebPart extends BaseClientSideWebPart<IMSptablev2WebPartProps> {
  ...
  public render(): void {
    const element: React.ReactElement<IMSptablev2Props> = React.createElement(
      MSptablev2,
      {
              ...
              groupFields: [
                ...
                this._propertyFieldCollectionData('filterConfiguration', {
                  ...
                  fields: [
                    ...
                    {
                      id: 'inDefaultFilterView',
                      title: strings.PropertyPane.inDefaultFilterView,
                      type: this._customCollectionFieldType.boolean
                    }
                  ]
                }),
