define([], function() {
  return {
    ...
    PropertyPane: {
      ListFieldLabel: 'List to load',
      EditRefinersLabel: 'Edit filters',
      RefinersFieldDescription: 'Specifies managed properties used as filters. If there are no values for a filter property, it wont appear in the panel.',
      RefinersFieldLabel: 'Filters',
      ShowExpanded: 'Expand filter by default',
      showValueFilter: 'Show filter for filter values',
      inDefaultFilterView: 'Show in default filter view',
      Search: 'Internal names for Search (,)',
      debugTitle: 'Application testing?',
      debugLabel: 'Yes',
      PropertyEdit: 'Edit properties in JSON',
      Templates: {
        ...
        FilterInternalName: 'Filter Internal Name'
      }
    }
  }
});